...
<div class="qeditor_toolbar">
  <a href="#" data-action="bold" class="qe-bold"><i class='mdi-editor-format-bold' title="Bold"></i></a> 
  <a href="#" data-action="italic" class="qe-italic"><i class='mdi-editor-format-italic' title="Italic"></i></a> 
  <a href="#" data-action="underline" class="qe-underline"><i class='mdi-editor-format-underline' title="Underline"></i></a> 
  <a href="#" data-action="strikethrough" class="qe-strikethrough"><i class='mdi-editor-format-strikethrough' title="Strike-through"></i></a>    
  ...
  <span class="qe-icon qe-heading">
    ...
    <i class="mdi-editor-format-size"></i>
  </span>
  <span class="vline"></span>
  <a href="#" data-action="insertorderedlist" class="qe-ol"><i class='mdi-editor-format-list-numbered' title="Insert Ordered-list"></i></a> 
  <a href="#" data-action="insertunorderedlist" class="qe-ul"><i class='mdi-editor-format-list-bulleted' title="Insert Unordered-list"></i></a> 
  <a href="#" data-action="indent" class="qe-indent"><i class="mdi-editor-format-indent-increase" title="Indent"></i></a> 
  <a href="#" data-action="outdent" class="qe-outdent"><i class='mdi-editor-format-indent-decrease' title="Outdent"></i></a> 
  <span class="vline"></span> 
  <a href="#" data-action="insertHorizontalRule" class="qe-hr"><i class="mdi-content-remove" title="Insert Horizontal Rule"></i></a> 
  <a href="#" data-action="blockquote" class="qe-blockquote"><i class="mdi-editor-format-quote" title="Blockquote"></i></a> 
  <a href="#" data-action="pre" class="qe-pre"><i class='mdi-action-settings-ethernet' title="Pre"></i></a> 
  <a href="#" data-action="createLink" class="qe-link"><i class='mdi-editor-insert-link' title="Create Link" title="Create Link"></i></a> 
  <a href="#" data-action="insertimage" onmousedown="event.preventDefault();" class="qe-image"><i class='mdi-editor-insert-photo' title="Insert Image"></i></a> 
  <a href="#" onclick="return QEditor.toggleFullScreen(this);" class="qe-fullscreen pull-right"><i class='mdi-action-open-with' title="Toggle Fullscreen"></i></a> 
</div>
"""
...
window.QEditor = 
  ...
  waitImageURL: ->
    return new Promise((resolve)->
      $("#editor-upload-image-confirm").on 'click', ->
        resolve()
    )
